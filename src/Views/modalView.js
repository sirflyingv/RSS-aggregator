export default (watchedState, i18nInstance, elements) => {
  const {
    modalTitle, modalBody, fullArticleButton, modalCloseButton, modalWindow, modalBackdrop,
  } =
    elements;

  const modalPost = watchedState.posts.find((post) => post.postId === watchedState.ui.modalPostId);
